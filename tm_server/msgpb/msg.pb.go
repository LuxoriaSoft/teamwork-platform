...
func (x *MsgMessage) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *MsgMessage) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_proto_msg_proto_rawDesc = "" +
	...
	"\tMsgStream\x12\x0f.msg.MsgMessage\x1a\x0f.msg.MsgMessage(\x010\x01B\tZ\a./msgpbb\x06proto3"
...
var file_proto_msg_proto_goTypes = []any{
	(*MsgMessage)(nil), // 0: msg.MsgMessage
}
var file_proto_msg_proto_depIdxs = []int32{
	0, // 0: msg.MessageService.MsgStream:input_type -> msg.MsgMessage
	0, // 1: msg.MessageService.MsgStream:output_type -> msg.MsgMessage
